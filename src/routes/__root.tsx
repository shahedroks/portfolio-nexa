...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "NexaSoft" },
      {
        property: "og:title",
        content: "Flutter Developer for US Clients | Mobile App, Admin Panel & Web — NexaSoft",
      },
      {
        property: "og:description",
        content:
          "Flutter apps, admin panels, and websites for US clients — clear timelines and production-ready delivery.",
      },
