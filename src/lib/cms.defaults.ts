...
import screenDashboardAdmin from "@/assets/hero-dashboard-admin-v2.png";
...
import type { CmsBundle, CmsProject, CmsSiteLinks } from "@/lib/cms.types";
...
function defaultLinks(): CmsSiteLinks {
  const whatsapp =
    envStr("VITE_WHATSAPP_NUMBER")?.replace(/\D/g, "") || "8801000000000";
  return {
    whatsappNumber: whatsapp,
    messengerPage: envStr("VITE_MESSENGER_PAGE") || "nexasoft",
    bookingEmbedUrl:
      envStr("VITE_BOOKING_EMBED_URL") || envStr("VITE_CALENDLY_URL") || "",
    githubUrl: envStr("VITE_GITHUB_URL") || "https://github.com/",
    linkedinUrl: envStr("VITE_LINKEDIN_URL") || "https://www.linkedin.com/",
    upworkUrl: envStr("VITE_UPWORK_URL") || "https://www.upwork.com/freelancers/",
    fiverrUrl: envStr("VITE_FIVERR_URL") || "https://www.fiverr.com/",
    contactEmail: envStr("VITE_CONTACT_EMAIL") || "mailto:ssnexasoft777@gmail.com",
    estimatePdfUrl: envStr("VITE_ESTIMATE_PDF_URL") || "/project-estimate-guide.pdf",
  };
}

const projectCoverFallback: Record<string, string> = {
...
const projectGalleryFallback: Record<string, string[]> = {
...
function defaultProjects(): CmsProject[] {
  return staticProjects.map((p, index) => ({
    ...p,
    coverUrl: projectCoverFallback[p.slug] ?? screenDashboard,
    galleryUrls: projectGalleryFallback[p.slug] ?? [projectCoverFallback[p.slug] ?? screenDashboard],
    order: index + 1,
    published: true,
  }));
}

export function getCmsDefaults(): CmsBundle {
  ...
  return {
    ...
    sections: {
      hero: {
        ...
        badgeSecondary: "Remote · Global clients",
        headlineBefore: "Product-ready ",
        headlineAccent: "Flutter apps",
        headlineAfter: ", admin systems & web platforms",
        subcopy:
          "NexaSoft helps startups and growing teams ship cross-platform mobile apps, secure dashboards, and conversion-focused websites — with clean architecture, clear timelines, and code you fully own.",
        chips: ["Flutter · iOS & Android", "Admin panels & APIs", "App Store & Play Store"],
        primaryCta: { label: "Book a Call", href: "#book" },
        secondaryCta: { label: "View selected work", href: "#projects" },
        connectLabel: "Connect",
        trustedStrip: {
          eyebrow: "Proven delivery",
          copy: "Results clients care about — shipped apps, clear communication, and on-time launches.",
          platforms: ["Flutter", "iOS", "Android", "Admin Panels", "Web Apps"],
          proofs: [
            { value: "50+", label: "Projects shipped", iconKey: "FolderCheck" },
            { value: "30+", label: "Happy clients", iconKey: "Users" },
            { value: "5+", label: "Years experience", iconKey: "Clock3" },
            { value: "4.9★", label: "Average rating", iconKey: "Star" },
          ],
        },
        mockups: {
          screens: [
            { src: screenDashboardAdmin, alt: "Admin analytics dashboard", kind: "laptop" },
            { src: screenFinance, alt: "Wallet mobile app", kind: "phone" },
            { src: screenFitness, alt: "Fitness mobile app", kind: "phone" },
          ],
          proofs: [
            {
              label: "4.9★ Rating",
      ...
      about: {
        ...
        bio: "I'm a full-stack developer with 5+ years building cross-platform mobile apps, admin panels, and websites for startups and agencies across the US, UK, and Australia. I work end-to-end — from Flutter interfaces and Node.js APIs to app store launches and post-release support. My focus is simple: clear communication, predictable timelines, and software that measurably moves your business metrics. Every project ships with clean, documented code you fully own.",
        portraitUrl: aboutPortrait,
        portraitAlt: "NexaSoft founder portrait",
      ...
      services: {
        ...
        subtitle:
          "One partner for design, mobile, web, and backend — so nothing gets lost between handoffs.",
        items: [
          {
            iconKey: "Smartphone",
      ...
      portfolio: {
        ...
        subtitle:
          "Apps, dashboards, and websites shipped for founders and agencies — with clear outcomes, not just screenshots.",
        filters: ["All", "Mobile Apps", "Admin Panels", "Websites", "UI/UX"],
      },
      process: {
        eyebrow: "End-to-End Process",
        title: "From first message to App Store & Play Store",
        subtitle:
          "A clear step-by-step workflow — requirement to design, development, integration, and store launch.",
        steps: [
          {
      ...
      tech_stack: {
        ...
        subtitle:
          "A pragmatic stack chosen for speed of delivery, long-term maintainability, and easy handover to your in-house team.",
        items: [
          { name: "Flutter", iconKey: "Smartphone" },
          { name: "Dart", iconKey: "Code2" },
          { name: "Firebase", iconKey: "Flame" },
          { name: "REST API", iconKey: "Server" },
          { name: "Node.js", iconKey: "Server" },
          { name: "Express.js", iconKey: "Network" },
          { name: "MySQL", iconKey: "Database" },
          { name: "PostgreSQL", iconKey: "Cylinder" },
          { name: "MongoDB", iconKey: "Leaf" },
          { name: "Figma", iconKey: "Figma" },
          { name: "Git & GitHub", iconKey: "GitBranch" },
          { name: "Provider / Bloc", iconKey: "Layers" },
          { name: "Payment Gateways", iconKey: "CreditCard" },
      ...
      why_me: {
        ...
        subtitle:
          "Great code matters. So does knowing your project is in dependable hands from kickoff to launch.",
        values: [
          {
            iconKey: "MessageSquare",
            title: "Clear & Fast Communication",
            description:
              "Daily updates on Slack or email, and replies within a few hours — never days.",
          },
          {
            iconKey: "Clock",
            title: "US Time-Zone Friendly",
            description:
              "Overlapping hours for EST and PST calls, so feedback loops stay same-day.",
          },
          {
            iconKey: "DollarSign",
            title: "Transparent Pricing",
            description:
              "Fixed-scope quotes or clear hourly rates. No hidden fees, no scope-creep invoices.",
          },
          {
            iconKey: "CalendarCheck",
            title: "On-Time Delivery",
            description:
              "Milestone-based schedules with a 100% on-time record across 50+ projects.",
          },
          {
            iconKey: "LifeBuoy",
            title: "Post-Launch Support",
            description:
              "30 days of free bug fixes, plus optional monthly maintenance retainers.",
          },
          {
            iconKey: "ShieldCheck",
            title: "NDA & Code Ownership",
            description:
              "Happy to sign your NDA. You own 100% of the source code and all repositories.",
          },
        ],
      },
      pricing: {
        ...
        subtitle:
          "Transparent ranges so you can plan with confidence — final quotes always match your scope.",
        footerNote:
          "All prices are in USD. Deposits are charged securely via Stripe. Final quotes depend on scope, platforms, integrations, and timeline — share a brief and we'll send a fixed quote before remaining work starts.",
        plans: [
          {
            id: "starter",
            name: "Starter",
            price: "$2,500+",
            depositLabel: "Deposit $500",
            depositNote:
              "Pay a $500 deposit to reserve a kickoff — balance invoiced after scope.",
          ...
          },
          {
            ...
            name: "Growth",
            price: "$7,500+",
            depositLabel: "Deposit $1,500",
            depositNote:
              "Pay a $1,500 deposit to reserve a kickoff — balance invoiced after scope.",
            description:
              "Production apps and dashboards ready for real users and ops teams.",
            featured: true,
            checkout: true,
            bullets: [
          ...
          },
          {
            ...
            price: "Custom quote",
            depositLabel: "Get a Quote",
            depositNote:
              "Share your scope and we'll send a fixed quote before any work starts.",
            description:
              "Multi-product systems, complex integrations, and ongoing partnership.",
            featured: false,
            checkout: false,
            bullets: [
      ...
      hire: {
        ...
        subtitle:
          "You can also hire and pay securely through these platforms — with their built-in buyer protection.",
        platforms: [
          {
            name: "Fiverr",
      ...
      testimonials: {
        ...
        subtitle:
          "Long-term relationships built on delivery — 8 out of 10 clients come back for a second project.",
        platformRatings: [
      ...
      faq: {
        ...
        subtitle:
          "Straight answers on timeline, ownership, payments, and how we work with US clients.",
        faqs: [
          {
      ...
      contact: {
        ...
        subtitle:
          "Book a discovery call on the calendar below, or send a project brief — no extra redirects.",
        responseLabel: "I usually respond within 24 hours",
        projectTypes: [
        ...
        connectCopy:
          "Prefer a quick chat? Reach out on any platform below — WhatsApp usually gets the fastest reply.",
      },
      lead_capture: {
        title: "Get a free project estimate",
        subtitle: "Leave your email & phone — we'll reply within 24 hours.",
        delayMs: 12000,
      },
    },
